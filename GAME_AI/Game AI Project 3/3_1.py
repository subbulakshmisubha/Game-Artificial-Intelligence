...
if __name__ == '__main__':
    ...
    for i in range (0,noOfGames):
        ...
        while move_still_possible(gameState) and noWinnerYet:
            ...
            if(player==1):
                ...
                best_move = minimax(player, gameState, 2)
        ...
        time_taken_for_game.append(time.time() - start_time_game)
    ...
    print "\n Average Time taken for each game:",(sum(time_taken_for_game)/len(time_taken_for_game))
